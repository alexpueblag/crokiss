...
El tablero real vive en `yodesarrollomx/crokiss` y se sirve en:
<https://yodesarrollomx.github.io/crokiss/>
...
`https://alexpueblag.github.io/crokiss/` daria 404 para siempre.
